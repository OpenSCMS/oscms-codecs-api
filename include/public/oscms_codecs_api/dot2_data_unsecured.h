...
/**
 * @file dot2_data_unsecured.h
 * @brief Encode and decode an Ieee1609Dot2DataUnsecured structure
 *
 * See IEEE 1609.2.1-2022 Section 7.5.10
 */

#ifndef OSCMS_DOT2_UNSECURED_H
#define OSCMS_DOT2_UNSECURED_H
...
#include "oscms_codecs_api/so_export.h"
    ...
    /**
     * Embed a payload into a COER encoded Ieee1609Dot2DataUnsecured
     *
    ...
    /**
     * Decode a COER encoded Ieee1609Dot2DataUnsecured and extract the payload
     *
     * @param encoded The COER encoded Ieee1609Dot2DataUnsecured
